...
const navItems: NavItem[] = [
  ...
  { name: 'รีวิว', href: '/agent/reviews', icon: <ReviewIcon /> },
  { name: 'ข้อความด่วน', href: '/agent/templates', icon: <TemplateIcon /> },
  { name: 'แจ้งเตือน', href: '/agent/notifications', icon: <BellIcon /> },
