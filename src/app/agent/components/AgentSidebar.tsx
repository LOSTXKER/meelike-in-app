...
export default function AgentSidebar() {
  ...
  return (
    <aside className="w-64 bg-surface dark:bg-dark-surface border-r border-default hidden lg:block">
      <div className="h-full flex flex-col">
        {/* Header */}
        <div className="p-4 border-b border-default">
          <h2 className="text-lg font-bold text-primary">Agent Center</h2>
          <p className="text-xs text-secondary mt-0.5">จัดการร้านค้าและลูกค้า</p>
        </div>
        ...
        <div className="p-4">
          <Link
            ...
            className="w-full flex items-center justify-center gap-2 bg-brand-primary hover:bg-brand-primary/90 text-white font-medium py-2.5 px-4 rounded-lg transition-colors"
          >
            <PlusIcon />
        ...
        <div className="p-4 border-t border-default">
          <div className="bg-gradient-to-r from-amber-500/10 to-amber-600/10 dark:from-amber-500/20 dark:to-amber-600/20 rounded-lg p-3">
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-secondary">ทดลองใช้</span>
            </div>
            <p className="text-xs text-secondary">เหลือ 5 วัน</p>
            <Link
