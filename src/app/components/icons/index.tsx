...
export const ShoppingCartIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
...
export const ReceiptIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const StarOutlineIcon = ({ className = "w-5 h-5" }: IconProps) => (
...
export const QuestionMarkCircleIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const CoinIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} viewBox="0 0 24 24" fill="currentColor">
...
export const CreditCoinIcon = ({ className = "w-5 h-5" }: IconProps) => (
  <svg className={className} viewBox="0 0 20 20" fill="none">
    <circle cx="10" cy="10" r="9" fill="currentColor" />
    <circle cx="10" cy="10" r="7" stroke="white" strokeWidth="1" strokeOpacity="0.3" fill="none" />
    <text x="10" y="14" textAnchor="middle" fontSize="9" fontWeight="bold" fill="white">฿</text>
  </svg>
);
